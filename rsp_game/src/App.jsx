  ...
  return (
    <div className='App'>
      ...
      <div id="buttons-container">
        <button><img src={process.env.PUBLIC_URL + "/images/rock.png"}
          alt="rock" onClick={() => play('Rock')} /></button>
        <button><img src={process.env.PUBLIC_URL + "/images/paper.png"}
          alt="paper" onClick={() => play('Paper')} /></button>
        <button><img src={process.env.PUBLIC_URL + "/images/scissors.png"}
          alt="scissors" onClick={() => play('Rock')} /></button>
    ...
    renderGameHistory();
    ">
          <img id="reset-img" src="images/reset.jpg" alt="reset" />
        </button>
      </div>
